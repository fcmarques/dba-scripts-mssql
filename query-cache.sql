...
v1.4.1 - 2014-03-26
 - fixed a bug with row count version detection
 ...
 * procedure cache information in it. The next query will produce a 
 * detailed set of results. The third query will product a set of 
