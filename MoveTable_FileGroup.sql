USE 
GO
--exec SP_MOVE_TABLES @SourceFileGroupID=1, @TargetFileGroupID=52, @TableToMove='abertura_pdv',@MovePKAndAllUniqueConstraints=1,@MoveAllNonClusteredIndexes=1

/****** Object:  StoredProcedure [dbo].[SP_MOVE_TABLES]    Script Date: 08/19/2011 09:15:02 ******/
SET ANSI_NULLS ON
GO
