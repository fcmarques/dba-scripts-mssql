USE [dbWarden]
GO
/****** Object:  StoredProcedure [dbo].[rpt_HealthReport]    Script Date: 12/21/2020 12:54:33 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	CREATE TABLE #REPLINFO (
		...
		[min distrib retention] INT NULL, 
		[max distrib retention] INT NULL, 
		[history retention] INT NULL,
		[history cleanup agent] NVARCHAR(500) NULL,
		[distribution cleanup agent] NVARCHAR(500) NULL,
		[rpc server name] NVARCHAR(200) NULL,
		[rpc login name] NVARCHAR(200) NULL,
		publisher_type NVARCHAR(200) NULL,
		[deletebatchsize_xact]	INT NULL, -- VB:2017-11-09-10:01 Field added
		[deletebatchsize_cmd]	INT NULL, -- VB:2017-11-09-10:01 Field added
		[dist_listener] sysname NULL
		)
