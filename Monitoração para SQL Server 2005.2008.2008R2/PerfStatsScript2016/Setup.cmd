...
@rem  set SQLDIAGCMD=C:\Program Files\Microsoft SQL Server\130\Tools\Binn\SQLdiag.exe

@rem set SQLDIAGCMD="C:\Program Files\Microsoft SQL Server\130\Tools\Binn\SQLdiag.exe"


SQLDiag.exe /R /A SQL2016 /I "%cd%\SQLDiagPerfStats_NoTrace.XML" /O "%cd%\Output\SQLDiagOutput" /P %cd% /C 1 /N 2