...
RAISERROR ('-- Thread Stats --', 0, 1) WITH NOWAIT
select th.os_thread_id, ta.scheduler_id, ta.session_id, ta.request_id, req.command, req.cpu_time,  req.logical_reads,req.total_elapsed_time,
txt.text from sys.dm_os_threads th join sys.dm_os_tasks ta on th.worker_address = ta.worker_address
