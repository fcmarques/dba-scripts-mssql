...
BEGIN'
    ...
    ELSE BEGIN -- SQL Server authentication
        ...
        SELECT @is_policy_checked = CASE is_policy_checked WHEN 1 THEN 'ON' WHEN0 THEN 'OFF' ELSE NULL END FROM sys.sql_logins WHERE name = @name
...
Select @tmpstrRole = @tmpstrRole
                   ...
                   From (select convert(varchar(100),suser_sname(sid)) as[LoginName],
                        ...
                        or    diskadmin<>0
                        or    dbcreator<>0
                        or    bulkadmin<>0) and name=@name ) L
