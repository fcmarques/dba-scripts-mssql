...
--															 SP2 Branch Retired					5794        SP3 CU7
--																								5828        SP3 CU8
...
--                                          10.50.2868  SP1 CU10    --->			10.50.4270  SP2 CU4	
...
-- Page Life Expectancy (PLE) value for each NUMA node in current instance  (Query 28)
...
-- Find single-use, ad-hoc and prepared queries that are bloating the plan cache  (Query 31)
...
-- Get the average full backup size by month for the current database (SQL 2008) (Query 53)
