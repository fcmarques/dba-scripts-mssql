...
USE [Dbalog]
GO
/****** Object:  StoredProcedure [dbo].[stpAlerta_Processo_Bloqueado]    Script Date: 23/05/2017 15:47:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[stpAlerta_Processo_Bloqueado]
AS
BEGIN
	SET NOCOUNT ON
	...
	DECLARE	@Subject VARCHAR(500), @Fl_Tipo TINYINT, @Qtd_Segundos INT, @Consulta VARCHAR(8000), @Importance AS VARCHAR(6), @Dt_Atual DATETIME,
			...
			@EmailOperator AS VARCHAR(100), @EmailProfile AS VARCHAR(100), @Qt_Lock INT

	-- Quantidade em Minutos
	SELECT	@Qt_Tempo_Lock		= 10,							-- Query que esta sendo bloqueada (rodando a mais de 2 minutos)
			@Qt_Lock			= 5,							-- Quantidade minima de processos bloqueados
			@Qt_Tempo_Raiz_Lock	= 1,							-- Query que esta gerando o lock (rodando a mais de 1 minuto)
			@EmailOperator		= 'ti-sup-dba@riachuelo.com.br',-- Email do operador
			@EmailProfile		= 'DBA'							-- Profile de email
	...
	*******************************************************************************************************************************/	
	IF ((EXISTS	(
		...
		OR (
				SELECT COUNT(*)	
				FROM #Resultado_WhoisActive A
				JOIN #Resultado_WhoisActive B ON A.[blocking_session_id] = B.[session_id]) >= @Qt_Lock
		)
	...
	BEGIN	-- INICIO - ALERTA
		...
		BEGIN
			...
			*******************************************************************************************************************************/							
			...
			--------------------------------------------------------------------------------------------------------------------------------
			SET @AlertaLockRaizHeader = '<font color=black bold=true size=4 face=arial >'			            
			...
			SET @AlertaLockRaizTable = CAST( (
				SELECT td =		  '<font size=2 face=arial>' +  [Nr_Nivel_Lock]			+ '</font></td>'
							+ '<td><font size=2 face=arial>' +	[Duração]				+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [database_name]			+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [login_name]			+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [host_name]				+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [start_time]			+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [status]				+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [session_id]			+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [blocking_session_id]	+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [Wait]					+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [open_tran_count]		+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [CPU]					+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [reads]					+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [writes]				+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [sql_command]			+ '</font></td>'
			...
			SET @AlertaLockRaizTable = 
					...
					+	'<tr>
							<th bgcolor=#0B0B61 width="80"><font color=white size=2 face=arial>Nivel Lock</font></th>
							<th bgcolor=#0B0B61 width="140"><font color=white size=2 face=arial>[dd hh:mm:ss.mss]</font></th>
							<th bgcolor=#0B0B61 width="100"><font color=white size=2 face=arial>Database</font></th>
							<th bgcolor=#0B0B61 width="120"><font color=white size=2 face=arial>Login</font></th>
							<th bgcolor=#0B0B61 width="120"><font color=white size=2 face=arial>Host Name</font></th>
							<th bgcolor=#0B0B61 width="200"><font color=white size=2 face=arial>Hora Início</font></th>
							<th bgcolor=#0B0B61 width="120"><font color=white size=2 face=arial>Status</font></th>
							<th bgcolor=#0B0B61 width="30"><font color=white size=2 face=arial>ID Sessão</font></th>
							<th bgcolor=#0B0B61 width="60"><font color=white size=2 face=arial>ID Sessão Bloqueando</font></th>
							<th bgcolor=#0B0B61 width="120"><font color=white size=2 face=arial>Wait</font></th>
							<th bgcolor=#0B0B61 width="60"><font color=white size=2 face=arial>Transações Abertas</font></th>
							<th bgcolor=#0B0B61 width="120"><font color=white size=2 face=arial>CPU</font></th>
							<th bgcolor=#0B0B61 width="120"><font color=white size=2 face=arial>Reads</font></th>
							<th bgcolor=#0B0B61 width="120"><font color=white size=2 face=arial>Writes</font></th>
							<th bgcolor=#0B0B61 width="300"><font color=white size=2 face=arial>Query</font></th>
						</tr>'    
			...
			--	ALERTA - HEADER
			--------------------------------------------------------------------------------------------------------------------------------
			SET @AlertaLockHeader = '<font color=black bold=true size=4 face=arial>'			            
			...
			SET @AlertaLockTable = CAST( (
				SELECT td =		  '<font size=2 face=arial>' +  [Duração]				+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [database_name]			+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [login_name]			+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [host_name]				+ '</font></td>'
							+ '<td><font size=2 face=arial>' +  [start_time]			+ '</font></td>'
