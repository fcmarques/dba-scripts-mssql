...
DECLARE @AuditCMD VARCHAR(MAX)

DECLARE database_cursor CURSOR FOR 
SELECT name 
FROM sys.databases
WHERE state_desc  = 'ONLINE'
--AND name IN ('DBALOG','CRIP','AUTORIZADOR')
...
BEGIN
	...
	INSERT INTO #AuditPermissions
	SELECT DB_NAME() as DatabaseName, * 
	FROM cte_perms
	WHERE LoginName = ''RIACHUELO\TLMKT Natal''
	'
