...
FOR 
SELECT TOP 10 name FROM sys.server_principals WHERE type_desc='WINDOWS_GROUP' AND NAME NOT IN ('NT SERVICE\MSSQLSERVER','NT SERVICE\ClusSvc','NT SERVICE\SQLSERVERAGENT')
