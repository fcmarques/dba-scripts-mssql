...
/*********************************************************************************************
Restore Generator v5.0 (2016-06-03)
(C) 2012, Paul Brewer
...
DECLARE @UseDefaultDatabaseBackupPath_ BIT;
SET @UseDefaultDatabaseBackupPath_ = @UseDefaultDatabaseBackupPath;
...
(
    SELECT
        ...
        ,CASE ISNULL(@TargetDatabase_,'') WHEN '' THEN mf.Physical_Name ELSE mf.Physical_Name + '.' +  @TargetDatabase_ END  AS PhysicalName
...
--    WHEN 'Actual' THEN b.physical_name
    WHEN 'Actual' THEN CASE ISNULL(@TargetDatabase_,'') WHEN '' THEN b.Physical_Name ELSE b.Physical_Name + '.' +  @TargetDatabase_ END
