...
DECLARE cursor_n1 CURSOR FOR
	...
	FETCH NEXT FROM cursor_n1 INTO @banco, @id
		...
		BEGIN
		set @caminho = '\\r-bkpmedia01\dbgen\'+@banco+'.bak'
		print @caminho	
		...
		set @cmd = 'BACKUP DATABASE '+@banco+' tO  DISK = '''+@caminho+''' WITH DIFFERENTIAL, RETAINDAYS = 5, NOFORMAT, INIT, SKIP, NOREWIND, NOUNLOAD,  STATS = 10'
		exec sp_executesql @cmd
		--print @cmd
