USE [master]
GO
/****** Object:  StoredProcedure [dbo].[sp_Incremental_Shrink_DB_File]    Script Date: 29/07/2015 14:14:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
 
CREATE PROC [dbo].[sp_Incremental_Shrink_DB_File]
(
	-- sp_Incremental_Shrink_DB_File.sql
	/*
...
sys.sp_MS_marksystemobject sp_Incremental_Shrink_DB_File
GO